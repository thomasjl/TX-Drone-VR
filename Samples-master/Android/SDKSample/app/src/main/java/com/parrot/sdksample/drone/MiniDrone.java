...
public class MiniDrone {
    ...
    public void takeOff() {
        Log.w(TAG, "take off mini drone");
        if (mDeviceController != null)
        {
            Log.v(TAG,"mDeviceController null");
        }

        if (mState.equals(ARCONTROLLER_DEVICE_STATE_ENUM.ARCONTROLLER_DEVICE_STATE_RUNNING)) {
            Log.v(TAG,"mState.equals(ARCONTROLLER_DEVICE_STATE_ENUM.ARCONTROLLER_DEVICE_STATE_RUNNING)");
        }
    ...
    public void emergency() {
        Log.w(TAG, "emergency mini drone");
        if ((mDeviceController != null) && (mState.equals(ARCONTROLLER_DEVICE_STATE_ENUM.ARCONTROLLER_DEVICE_STATE_RUNNING))) {
