...
import com.parrot.sdksample.communication.SocketClient;
...
public class MiniDroneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.v(TAG,"CREATION DRONE mini drone");

        mMiniDrone = new MiniDrone(this, service);

        //create server socket
        //SocketServer mSocketServer = new SocketServer(52433, mMiniDrone);
        //mSocketServer.execute();
